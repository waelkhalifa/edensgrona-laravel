    ...
    <div class="container">
        <div class="row pt-7">
            ...
            <div class="logo col-md-4 col-sm-12 text-center">
                <img class="footer-logo mb-sm-7" src="<?php echo e(asset('assets/img/logo.jpg')); ?>" alt="">
            </div>
            ...
            <span class="text-center small p-1" style="color: #ffffff7d;">
                Integritetspolicy och Cookie Inställningar. © <?php echo e(date('Y')); ?>
...
<?php /**PATH /Users/waelkhalifa/Sites/edensgrona/resources/views/layouts/partials/footer.blade.php ENDPATH**/ ?>