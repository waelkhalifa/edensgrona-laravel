<?php $__env->startSection('title', 'Edens Gröna - Hem'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroSettings->is_active): ?>
        <section class="hero-section">
            <!-- Background Video -->
            <div class="video-container">
                <video autoplay muted loop playsinline class="hero-video">
                    <source src="<?php echo e($heroSettings->background_video_path); ?>" type="video/mp4">
    ...
    <div class="container content-space-1">
        ...
        <div class="row" id="card-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="order-lg-0 col-sm-6 col-lg-4 mb-3 mb-sm-7 home-article-card" id="card<?php echo e($index + 1); ?>">
                    <!-- Card -->
                    <a class="card card-stretched-vertical card-transition service-card-hover"
                       href="#!"
                       style="background-image: url(<?php echo e($service->hasMedia('image') ? $service->image_url : asset('assets/img/default-service.jpg')); ?>);
                          min-height: 25rem;
                        ...
                        <div class="card-footer"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->icon): ?>
                                <i class="<?php echo e($service->icon); ?> text-white mb-2" style="font-size: 2rem;"></i>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="position-relative bg-dark"
         style="background-image: url(<?php echo e(asset('assets/img/wave-pattern-light.svg')); ?>);">
                        ...
                        <div class="col-md-6 col-lg-5 mb-3 mb-md-7">
                            ...
                            <div class="card p-3 h-100">
                                <div class="d-flex pe-lg-5 text-start" data-aos="fade-up"
                                     data-aos-delay="<?php echo e($step->step_number * 100); ?>">
                                    <div class="flex-shrink-0">
                                        <span class="svg-icon text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                                 viewBox="0 0 50 50">
                                                <text x="10" y="40" font-family="Arial" font-size="40"
                                                      fill="green"><?php echo e($step->step_number); ?></text>
                                            </svg>
                                        </span>
                                    </div>
    ...
    <div class="container text-center content-space-lg-1" id="videos">
        ...
        <section class="video-slid mb-7">
            <video id="slider" autoplay muted loop>
                <source src="<?php echo e(asset('assets/video/slide-3.mp4')); ?>" type="video/mp4">
            </video>
            <ul class="list-inline d-block navigation">
                <li onclick="videoUrl('<?php echo e(asset('assets/video/slide-4.mp4')); ?>')" class="white">
                    <i class="fa-solid fa-1"></i>
                </li>
                <li onclick="videoUrl('<?php echo e(asset('assets/video/slide-2.mp4')); ?>')" class="white">
                    <i class="fa-solid fa-2"></i>
                </li>
                <li onclick="videoUrl('<?php echo e(asset('assets/video/slide-1.mp4')); ?>')" class="white">
                    <i class="fa-solid fa-3"></i>
                </li>
                <li onclick="videoUrl('<?php echo e(asset('assets/video/slide-5.mp4')); ?>')" class="white">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/waelkhalifa/Sites/edensgrona/resources/views/home.blade.php ENDPATH**/ ?>